...
#include "IP_StageGimmick.generated.h"
...
UCLASS()
class INDIVIDUAL_PROJECT_API AIP_StageGimmick : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<class AIP_CharacterNonPlayer> OpponentClass;
...
protected:
	...
	TSubclassOf<class AIP_ItemBox> RewardBoxClass;

	UPROPERTY(VisibleAnywhere, Category = Reward, Meta = (AllowPrivateAccess = "true"))
	TArray<TWeakObjectPtr<class AIP_ItemBox>> RewardBoxes;
